...
int main(int argc, char* argv[]) {
    ...
    fill_circle_array(partiture, partiture_end+1);
	...
	((circle_array_end-circle_array_begin)>=0)?(100-(circle_array_end-circle_array_begin)):100-(100-circle_array_begin+circle_array_end));
	}
	...
	while (  (circle_array[circle_array_begin].remaining_ticks < 0)
        ...
        ((circle_array_end-circle_array_begin)>=0)?(circle_array_end-circle_array_begin):(100-circle_array_begin+circle_array_begin) );
